<div class="container">
    <div class="page-inner">
        ...
        <div class="page-header d-flex justify-content-between align-items-center">
            <h3 class="fw-bold">Manajemen Jadwal Kuliah</h3>
            <?php if ($_SESSION['user']['role'] == 'Admin'): ?>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah">
                    <i class="fa fa-plus me-1"></i> Tambah Jadwal Kuliah
                </button>
            <?php endif; ?>
        </div>
                                ...
                                <tr>
                                    ...
                                    <?php if ($_SESSION['user']['role'] == 'Admin'): ?>
                                        <td class="text-center">
                                            <a href="index.php?page=jadwalkuliahedit&id=<?= $row['id']; ?>"
                                                class="btn btn-sm btn-warning">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="index.php?page=jadwalkuliahhapus&id=<?= $row['id']; ?>"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">Tambah Jadwal Kuliah</h5>
            ...
            <form method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="simpan_jadwalkuliah" class="btn btn-primary">
                        Simpan
                    </button>
                </div>
            </form>
...
<?php
if (isset($_POST['simpan_jadwalkuliah'])) {
    ...
    mysqli_query($koneksi, "
        INSERT INTO jadwalkuliah (user_id, dosen, matakuliah, waktu, ruang)
        VALUES ('$user_id', '$dosen', '$matakuliah', '$waktu', '$ruang')
    ");

    $createdAt   = date('Y-m-d H:i:s');
    $judulNotif  = "Jadwal Kuliah Baru";
    $pesanNotif  = "Jadwal kuliah mata kuliah $matakuliah telah ditambahkan.";
    ...
    echo "<script>
        alert('Jadwal kuliah berhasil disimpan & notifikasi dikirim');
        window.location='index.php?page=jadwalkuliah';
    </script>";
    exit;
}
?>