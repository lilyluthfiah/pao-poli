...
// Proteksi: harus login dan role dosen
...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'dosen') {
  // kalau bukan dosen, lempar ke login (atau dashboard mahasiswa kalau mau)
...
<body>
  ...
  <script>
    // === JEMBATAN DARI PHP SESSION KE LOCALSTORAGE (Nambah, bukan ngurangin) ===
    localStorage.setItem("isLoggedIn", "true");
    localStorage.setItem("username", <?php echo json_encode($nama); ?>);
    localStorage.setItem("userRole", <?php echo json_encode($role); ?>);
